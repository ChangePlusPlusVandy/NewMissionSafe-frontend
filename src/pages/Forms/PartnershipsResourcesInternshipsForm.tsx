...
import { Button, TextInput, Group, Flex, Paper, Title, Space, RadioGroup, Radio } from '@mantine/core';
...
const PartnershipsResourcesInternshipsForm: React.FC<formProps> = ({ formID }) => {
    ...
    const submit = async (values: any) => {
        ...
        try {
            ...
            console.error("Error submitting Partnerships Reources & Internships Form")
        }
    };
    return (
        <Paper bg={"missionSafeBlue.9"} w={"100%"} h={"100%"} radius={0} pl={40} pr={40}>
            ...
            >
                <form onSubmit={form.onSubmit(submit, console.log)}>
                    ...
                    >
                        <Group mt="xs">
                            <Radio label="Resource" value="resource" styles={{ label: { color: 'white' } }} />
                            <Radio label="Internship" value="internship" styles={{ label: { color: 'white' } }} />
                            <Radio label="Partnership" value="partnership" styles={{ label: { color: 'white' } }} />
                        </Group>
                    </RadioGroup>
